  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ color: "#4b5563", fontSize: "1.125rem", lineHeight: 1.6, textAlign: "center", marginBottom: "2.5rem" }}>
          Your daily energy levels are driven by two competing biological forces that operate completely independently of one another.
        </p>

        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "1.5rem", textAlign: "left" }}>
          {/* Process H Card */}
          <div style={{ background: "rgba(139, 92, 246, 0.04)", border: "1px solid rgba(139, 92, 246, 0.2)", borderRadius: "12px", padding: "1.5rem" }}>
            <h4 style={{ color: "var(--violet)", fontWeight: 700, marginBottom: "0.75rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
              <span style={{ display: "inline-block", width: "10px", height: "10px", borderRadius: "50%", background: "var(--violet)" }}></span>
              Process H (The Homeostat)
            </h4>
            <p style={{ color: "#4b5563", fontSize: "0.95rem", lineHeight: 1.6, margin: 0 }}>
              This is your <strong>sleep pressure</strong>. While you are awake, your brain constantly burns energy, leaving behind a chemical byproduct called <strong>adenosine</strong>. Like sand filling an hourglass, adenosine steadily builds up in your brain throughout the day, creating an increasing biological hunger for sleep.
            </p>
          </div>

          {/* Process C Card */}
          <div style={{ background: "rgba(245, 158, 11, 0.04)", border: "1px solid rgba(245, 158, 11, 0.2)", borderRadius: "12px", padding: "1.5rem" }}>
            <h4 style={{ color: "var(--amber)", fontWeight: 700, marginBottom: "0.75rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
              <span style={{ display: "inline-block", width: "10px", height: "10px", borderRadius: "50%", background: "var(--amber)" }}></span>
              Process C (The Circadian Clock)
            </h4>
            <p style={{ color: "#4b5563", fontSize: "0.95rem", lineHeight: 1.6, margin: 0 }}>
              This is your <strong>alerting signal</strong>. Generated by the master clock in your brain, it sends out a rhythmic wave of wakefulness that cycles roughly every 24 hours. Crucially, it doesn&apos;t care how long you&apos;ve been awake or how much adenosine you have; it just cares what time of day it is.
            </p>
          </div>
        </div>
      </div>
