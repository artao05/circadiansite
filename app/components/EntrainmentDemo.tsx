    ...
    <div className="interactive-block entrainment">
      ...
      <div className="entrainment-grid">
        <div className="entrainment-visual visual-panel">
          ...
          <div
            className="offset-chart"
            aria-label="Internal clock offset over eight days"
          >
            {data.map((d) => {
              ...
              return (
                <div className="offset-day" key={d.day}>
                  ...
                  <div
                    ...
                    style={{ position: "relative", flex: 1, height: "24px" }}
                  >
                  ...
                  <span
                    ...
                    style={{
                      color: isStrained ? "#ef4444" : "#6b7280",
                      width: "40px",
                      textAlign: "right",
                    }}
                  >
        ...
        <div className="explain-panel">
          ...
          >
            <strong>Internal Desynchronization</strong> occurs when different
            tissue clocks drift apart. When the connecting band turns{" "}
            <span style={{ color: "#ef4444" }}>red</span>, it indicates over 2
            hours of misalignment between your brain and gut.
          </p>
        </div>
      </div>
    </div>
